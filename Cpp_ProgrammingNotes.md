...
Lambdas are **anonymous functions** generated by the compiler from expressios you write.  Like regular functions they have return values, for which the type can be infered from simple lambdas with one return statement, or can be explicitly specified.  They can function much like **callback functions**.
